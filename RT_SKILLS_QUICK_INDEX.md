...
|----------|----------|-----------|
| 口腔癌术后 PORT（舌/口底/颊黏膜/牙龈/硬腭/唇/磨牙后区） | `port-oral-postop` | `tongue-fom-port-escalation`（舌癌累及口底时必加）· `neoadjuvant-deescalation`（化免新辅助后） |
| 口腔癌术后 PORT（通用参考） | `oral-oropharynx-postop-rt-targets` | 同上 |
| **触发词**：舌癌术后、口底癌术后、颊黏膜术后、牙龈癌、硬腭、磨牙后区、皮瓣、口底铁律、颊淋巴结IX区、**舌癌累及口底** |
...
> 维护：朱国培 · 上海九院放疗中心
> 更新记录：2026-08-04 v1.1 新增 tongue-fom-port-escalation（舌癌累及口底提级规则，蒋雯提议/朱国培裁定）；2026-07-31 v1.0 创始版
